...
async def test_openai(request: ChatRequest):
    """
    Test OpenAI compatibility with the provided prompt.
    """
    try:
        ...
        if not response_content:
            raise HTTPException(
                status_code=500, detail="No response generated by OpenAI."
            )
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erreur lors de la communication avec OpenAI: {str(e)}",
        )
